window.onload = function () {
	...
	if (canvas.getContext) {
		...
		var vidas = 3;
		var pontuacao = "";
		var conta = ["2 x 12", "6 x 7", "5 x 8", "8 x 2", "5 x 10", "50 : 5", "36 : 4", "4 : 2", "56 : 7", "24 : 2", "15 + 15", "24 + 12", "8 + 3", "48 + 8", "50 + 11", "28 - 9", "94 - 10", "41 - 35", "70 - 22", "38-25"];
		var resultado = ["24", "42", "40", "16", "50", "10", "9", "2", "8", "12", "30", "36", "11", "56", "61", "19", "84", "6", "48", "13"];
		var check;
		var rightkey = false;
        var leftkey = false;
		var clicar = false;
		...
		var balao6 = new Balao(120, 2, 30, "orange", 250);
		var balao7 = new Balao(270, 2, 31, "#ff0066", 250);
		var balao8 = new Balao(420, 2, 32, "#00ff00", 250);
		var balao9 = new Balao(570, 2, 33, "#00ccff", 250);
		var balao10 = new Balao(720, 2, 34, "#99cc00", 250);
		...
		function desenho() {
			...
			if (ganhar == 1) {
				...
				setTimeout(function () {
					window.open("intermedio.html", "_self")
				}, 2500);
